...
rm -rf /mnt/resources/woolworths/extracted_infographics_txt
mkdir -p /mnt/resources/woolworths/extracted_infographics_txt
...
rm -rf /mnt/resources/woolworths/raw_infographics
mkdir -p /mnt/resources/woolworths/raw_infographics
...
gsutil -m cp -r "gs://woolworths_argo/extracted_infographics_txt/*" /mnt/resources/woolworths/extracted_infographics_txt/ 
...
gsutil -m cp -r "gs://woolworths_argo/raw_infographics/*" /mnt/resources/woolworths/raw_infographics/
